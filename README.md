...
NOTE: Due to the huge size, the file "tracks.csv" cannot be uploaded. Therefore, a screenshot of the file has been uploaded for an idea how the file is like.
